...
{ 
  ...
  20:	86c50513          	addi	a0,a0,-1940 # 888 <malloc+0xe4>
  24:	00000097          	auipc	ra,0x0
  28:	6c2080e7          	jalr	1730(ra) # 6e6 <printf>
        exit(-1); 
  2c:	557d                	li	a0,-1
  2e:	00000097          	auipc	ra,0x0
  32:	330080e7          	jalr	816(ra) # 35e <exit>
    }     
    sleep_ticks = atoi(argv[1]); 
  36:	6588                	ld	a0,8(a1)
  38:	00000097          	auipc	ra,0x0
  3c:	226080e7          	jalr	550(ra) # 25e <atoi>
  40:	8a2a                	mv	s4,a0
    n_proc = atoi(argv[2]); 
  42:	6888                	ld	a0,16(s1)
  44:	00000097          	auipc	ra,0x0
  48:	21a080e7          	jalr	538(ra) # 25e <atoi>
  4c:	892a                	mv	s2,a0
    if (n_proc > MAX_PROC) { 
  4e:	47a9                	li	a5,10
  ...
  66:	1fc080e7          	jalr	508(ra) # 25e <atoi>
  6a:	8aaa                	mv	s5,a0
        ret = fork(); 
  6c:	00000097          	auipc	ra,0x0
  70:	2ea080e7          	jalr	746(ra) # 356 <fork>
  ...
  7e:	384080e7          	jalr	900(ra) # 3fe <sched_tickets>
            while(1);  
  82:	a001                	j	82 <main+0x82>
        printf("Cannot test with more than %d processes\n", MAX_PROC); 
  84:	45a9                	li	a1,10
  86:	00001517          	auipc	a0,0x1
  8a:	83a50513          	addi	a0,a0,-1990 # 8c0 <malloc+0x11c>
  8e:	00000097          	auipc	ra,0x0
  92:	658080e7          	jalr	1624(ra) # 6e6 <printf>
        exit(-1); 
  96:	557d                	li	a0,-1
  98:	00000097          	auipc	ra,0x0
  9c:	2c6080e7          	jalr	710(ra) # 35e <exit>
        } 
        else { // parent 
            proc_pid[i] = ret; 
  ...
  b6:	33c080e7          	jalr	828(ra) # 3ee <sleep>
    sched_statistics(); 
  ba:	00000097          	auipc	ra,0x0
  be:	34c080e7          	jalr	844(ra) # 406 <sched_statistics>
  ...
  d2:	2c0080e7          	jalr	704(ra) # 38e <kill>
...
00000000000003fe <sched_tickets>:
...
0000000000000406 <sched_statistics>:
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 662:	29290913          	addi	s2,s2,658 # 8f0 <malloc+0x14c>
        while(*s != 0){
 ...
 758:	00e6ea63          	bltu	a3,a4,76c <free+0x50>
{
 ...
 79a:	16f73d23          	sd	a5,378(a4) # 910 <freep>
}
 79e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7cc:	14853503          	ld	a0,328(a0) # 910 <freep>
 ...
 7f4:	12090913          	addi	s2,s2,288 # 910 <freep>
  if(p == (char*)-1)
 7f8:	5afd                	li	s5,-1
 7fa:	a88d                	j	86c <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7fc:	00000797          	auipc	a5,0x0
 800:	11c78793          	addi	a5,a5,284 # 918 <base>
 804:	00000717          	auipc	a4,0x0
 808:	10f73623          	sd	a5,268(a4) # 910 <freep>
 80c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
